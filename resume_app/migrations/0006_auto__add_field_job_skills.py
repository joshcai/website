...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.skills'
        db.add_column(u'resume_app_job', 'skills',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.skills'
        db.delete_column(u'resume_app_job', 'skills')
    ...
    models = {
        ...
        u'resume_app.job': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'skills': ('django.db.models.fields.TextField', [], {'default': "''"}),
